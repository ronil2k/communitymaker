...
class ProfilesControllerTest < ActionController::TestCase
  ...
  test "should create profile" do
    assert_difference('Profile.count') do
      post :create, profile: { bio: @profile.bio, city: @profile.city, country: @profile.country, dob: @profile.dob, first_name: @profile.first_name, gender: @profile.gender, last: @profile.last, name: @profile.name, phone: @profile.phone, profile_pic: @profile.profile_pic, state: @profile.state, street: @profile.street, suburb: @profile.suburb, user_id: @profile.user_id }
    end
